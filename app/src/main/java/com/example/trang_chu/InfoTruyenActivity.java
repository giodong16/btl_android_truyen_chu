...
public class InfoTruyenActivity extends AppCompatActivity {
    ...
    private void getData() {
        ...
        if(bundle!=null){
            ...
            List<Truyen> truyenList=new TruyenDAO(this).getTruyenForItemVertical("Select tTruyen.MaTruyen,TenTruyen,Anh from tTruyen where MaTacGia=? and MaTruyen!= '"+truyen.getMaTruyen()+"' LIMIT 8",new String[]{truyen.getMaTacGia()});
            try{
            ...
            Truyen truyen=truyenDAO.getTruyenbyMaTruyen("TR001");
            textGioiThieu.setText(truyen.getGioiThieu());
        }
    }
}