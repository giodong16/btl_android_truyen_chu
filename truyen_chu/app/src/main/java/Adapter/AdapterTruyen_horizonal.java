...
public class AdapterTruyen_horizonal extends BaseAdapter
{
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
     ...
     /*   if(MainActivity.isDark){
            ...
            ImageView imageView2=convertView.findViewById(R.id.icon2);
            ImageView imageView3=convertView.findViewById(R.id.icon3);
            ImageView imageView4=convertView.findViewById(R.id.icon4);
            imageView1.setColorFilter(colorFilter);
