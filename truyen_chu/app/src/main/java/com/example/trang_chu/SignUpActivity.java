    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btnSignUp.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if(!isNotValid) {
                    ConstraintLayout success_constraintLayout=findViewById(R.id.constraintlayout_success);
                    View view= LayoutInflater.from(SignUpActivity.this).inflate(R.layout.susccess_dialog,success_constraintLayout);
                    Button btnDone=view.findViewById(R.id.success_done);
